    ...
    <div className="relative min-h-screen w-full flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in-up">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-emerald-700/80 mt-2 font-medium">Sistem Informasi Posyandu Digital</p>
        </div>
        ...
        <Card className="border border-slate-100 bg-white shadow-2xl overflow-hidden rounded-[2rem]">
          ...
          <CardHeader className="space-y-1 pb-6 pt-8">
            <CardTitle className="text-2xl font-bold text-slate-800 text-center">Selamat Datang</CardTitle>
            <CardDescription className="text-center text-slate-500 font-medium">
              Masuk untuk melanjutkan ke halaman dashboard
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <p className="text-center text-sm text-slate-600 mt-8">
          Belum punya akun?{" "}
          <Link to="/register" className="text-emerald-600 hover:text-emerald-500 underline underline-offset-4 font-bold transition-colors">
            Daftar sekarang
          </Link>
        </p>
      </div>
